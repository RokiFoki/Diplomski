...
i = 0
j = 0
with codecs.open(get_file_name_from_dates('slashes_player', dates), 'r', "utf-8-sig") as fin:	
	with codecs.open(get_file_name_from_dates('logs_player', dates), 'w', "utf-8-sig") as fout:		
		for line in fin:
			i += 1
